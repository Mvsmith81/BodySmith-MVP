...
assert.ok(html.includes('history-log.js?v=20260914-history261'));
assert.ok(sw.includes('history-log.js?v=20260914-history261'));
assert.ok(h.includes("type=\"datetime-local\""));
assert.ok(h.includes('setTimeout(()=>location.reload(),650)'));
assert.ok(h.includes("if(el.textContent!=='v2.6.1')"));
