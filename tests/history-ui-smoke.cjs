...
assert.ok(html.includes('history-log.js?v=20260915-release291'));
assert.ok(sw.includes('history-log.js?v=20260915-release291'));
assert.ok(h.includes("type=\"datetime-local\""));
assert.ok(h.includes('setTimeout(()=>location.reload(),650)'));
assert.ok(h.includes("if(el.textContent!=='v2.9.0')"));
