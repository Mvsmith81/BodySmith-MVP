...
assert.ok(html.includes('auth-upgrade.js?v=20260915-release291'));
assert.ok(html.includes('workout-flex.js?v=20260915-release291'));
assert.ok(sw.includes('bodysmith-release-2.9.0-release291'));
assert.ok(sw.includes('workout-flex.js?v=20260915-release291'));
assert.ok(sw.includes('auth-upgrade.js?v=20260915-release291'));
