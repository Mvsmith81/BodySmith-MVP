...
assert.ok(html.includes('auth-upgrade.js?v=20260915-release210'));
assert.ok(html.includes('workout-flex.js?v=20260915-release210'));
assert.ok(sw.includes('bodysmith-release-2.10.0-release210'));
assert.ok(sw.includes('workout-flex.js?v=20260915-release210'));
assert.ok(sw.includes('auth-upgrade.js?v=20260915-release210'));
