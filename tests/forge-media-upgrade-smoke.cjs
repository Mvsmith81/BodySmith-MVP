...
assert.ok(html.includes('forge-media-upgrade.js?v=20260915-release211'));
assert.ok(html.includes('release-210.css?v=20260915-release211'));
assert.ok(sw.includes('forge-media-upgrade.js?v=20260915-release211'));
assert.ok(sw.includes('release-210.css?v=20260915-release211'));
