...
for(const asset of ['release-29.css?v=20260915-release210','exercise-groups.js?v=20260915-release210','nutrition.js?v=20260915-release210'])assert.ok(html.includes(asset),asset);
assert.ok(sw.includes("bodysmith-release-2.10.0-release210"));
for(const asset of ['release-29.css?v=20260915-release210','exercise-groups.js?v=20260915-release210','nutrition.js?v=20260915-release210'])assert.ok(sw.includes(asset),asset);
