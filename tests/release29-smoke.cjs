...
for(const asset of ['release-29.css?v=20260915-release291','exercise-groups.js?v=20260915-release291','nutrition.js?v=20260915-release291'])assert.ok(html.includes(asset),asset);
assert.ok(sw.includes("bodysmith-release-2.9.0-release291"));
for(const asset of ['release-29.css?v=20260915-release291','exercise-groups.js?v=20260915-release291','nutrition.js?v=20260915-release291'])assert.ok(sw.includes(asset),asset);
